...
import { currencyFormat, formatDateTime, formatUSD } from "src/utils/format";
                  ...
                  return (
                    <TableRow hover key={transaction.id}>
                      ...
                      <TableCell align="right" sx={{ whiteSpace: "nowrap" }}>
                        {`${currencyFormat(transaction.amount / 100)} ${process.env.NEXT_PUBLIC_CURRENCY}`}
                      </TableCell>
                      <TableCell
                        sx={{
                          whiteSpace: "nowrap",
                      ...
                      >
                        <BalanceTransactionFlowDetails transaction={transaction} />
                      </TableCell>
                      <TableCell>
                      ...
                      <TableCell sx={{ whiteSpace: "nowrap" }}>
                        {transaction.description ? transaction.description : `Sample ${transaction.type}`}
                      </TableCell>
                    </TableRow>
                  );
                })}
